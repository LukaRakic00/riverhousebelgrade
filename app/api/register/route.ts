...
export async function POST(req: Request) {
	try {
		...
		await Registration.create({ fullName, email, phone, message });
		...
		if (process.env.RESEND_API_KEY) {
			try {
						...
						<body>
							<div class="container">
								...
								<div class="content">
									...
									<p>U međuvremenu, možete pogledati našu galeriju ili nas kontaktirati direktno.</p>
				...
				// Ne vraćamo grešku ako email ne uspe - registracija je sačuvana
			}
		}
